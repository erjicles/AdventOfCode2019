...
namespace AdventOfCode2019Test.Challenges
{
    public class Day14Test
    {
        ...
        public void GetQuantityOfComponentRequiredToGenerateOutputTest()
        {
            ...
            // 2) Requested quantity of component to generate:
            // 3) Output component
            ...
            {
                var result = Day14.GetQuantityOfComponentRequiredToGenerateOutput(
                    reactionDefinitions: testExample.Item1,
                    component: testExample.Item2,
        ...
        {
            int expected = 873899;
            int actual = Day14.GetDay14Part1Answer();
